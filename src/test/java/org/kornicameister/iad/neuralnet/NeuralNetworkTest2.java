...
//            errWriter.print(String.format("%.6f",error * 0.25));
    ...
    private NeuralNetwork readNetworkFromFile() {
        ...
        Neuron neuron_11 = new Neuron(true, function, new Double[]{0.472801, 0.935628, -0.491067, 0.372298});
        Neuron neuron_12 = new Neuron(true, function, new Double[]{-0.100727, 0.297812, -0.615205, -0.153709});
        neuron_11.setBiasWeight(0.0);
        neuron_12.setBiasWeight(0.0);

        Neuron neuron_21 = new Neuron(true, function, new Double[]{0.346888, 0.484956});
        Neuron neuron_22 = new Neuron(true, function, new Double[]{0.654139, -0.961072});
        Neuron neuron_23 = new Neuron(true, function, new Double[]{0.872161, 0.603206});
        Neuron neuron_24 = new Neuron(true, function, new Double[]{0.665244, -0.489092});
